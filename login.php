...
<header class="header">
      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:pujariharshavardhanbkp@gmail.com" class="contact-link">pujariharshavardhanbkp@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+918309211016" class="contact-link">+91 8309211016</a>
          </li>
        </ul>
  ...
  <main>
    <article>
      <section class="section hero" id="home" style="background-image: url('hero-bg.png'); margin: 0%;"
        aria-label="hero">
        ...
        <div class="container">
          ...
          <figure class="hero-banner">
            <img src="bg.svg" width="587" height="839" alt="hero banner" class="w-100">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="https://www.google.com/maps/place/SVIMS+Blood+Bank/@13.6377006,79.4043115,3a,75y,90t/data=!3m8!1e2!3m6!1sAF1QipMDm7AbqaPfskjaPDMj3lhZ1CllV0maKeF2pPah!2e10!3e12!6shttps:%2F%2Flh5.googleusercontent.com%2Fp%2FAF1QipMDm7AbqaPfskjaPDMj3lhZ1CllV0maKeF2pPah%3Dw114-h86-k-no!7i3968!8i2976!4m11!1m2!2m1!1stirupati+blood+store+center!3m7!1s0x3a4d4b1fa023389d:0xe9aba1763148f837!8m2!3d13.6377006!4d79.4043115!10e5!15sCht0aXJ1cGF0aSBibG9vZCBzdG9yZSBjZW50ZXKSAQpibG9vZF9iYW5r4AEA!16s%2Fg%2F1262vv7rh?entry=ttu&g_ep=EgoyMDI1MDMwNC4wIKXMDSoJLDEwMjExNDU1SAFQAw%3D%3D">
            <address class="item-text">
              Bc colony,<br>
              Bhakarapeta, Tirupathi, Andhra Pradesh.
            </address>
          </a>
          </li>
          <li class="footer-item">
            ...
            <a href="tel:+918309211016" class="footer-link">+91 8309211016</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:pujariharshavardhanbkp@gmail.com" class="footer-link">pujariharshavardhanbkp@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
